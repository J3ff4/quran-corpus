...
describe('BrowseList disclosure rows', () => {
  ...
  it('leaves every other browse row in the reading face', () => {
    // Juz, page and revealed rows carry no arabicFace. A default that reached
    // them would put a private-use surah-name font on ordinary Arabic text,
    // which has no glyphs for it -- tofu in three of the four browse modes.
